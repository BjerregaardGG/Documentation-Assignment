export const noter = [
    ...
    { titel: "JS objekter vs JSON", billede: "lektion_1/images/jsonvsjs.png", beskrivelse: `JS objekter og JSON kan godt ligne hinanden, men der er nogle forskelle, som man skal være opmærksom på, når man arbejder med dem. Begge har Key-Value pair. Der skal dog være anførselstegn på keys i JSON, men ikke på keys i JS objekter. Selmicolon kan anvendes efter objektet i JS, men ikke i JSON og det samme gælder for trading komma.` },
    { titel: "Type coercion", billede: "lektion_1/images/coercion.png", beskrivelse: `JS er et fleksibelt sprog, forstået på den måde, at det automatisk konverterer typer. Hvis vi eksempelvi lægger en 'int' sammen med en 'string', så vil JS konvertere vores int til en string, hvilket kan give os et resultat som vi ikke er interesset i. Vi kan undgå type coercion gennem nedenstående teknikker.` },
    { titel: "REST API Design", billede: "lektion_1/images/rest_api_design.png", deklerationer: [ 
